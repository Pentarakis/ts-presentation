...
![Die Grafik zeigt eine politische Karte von Europe.  Die Standorte von adesso in europäsichen Ländern Ländern sind markiert. 
 Die Standorte in Spanien sind: Madird, Barcelona, Jerez de la Fontera.
 Der Standorte in der Türkei ist Istanbul. Der Standorte in Bulgarien ist: Sofia ]
(./adesso/images/adessoMapEU.png)
